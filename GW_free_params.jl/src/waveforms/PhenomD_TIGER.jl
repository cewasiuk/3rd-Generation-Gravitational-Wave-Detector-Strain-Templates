...
# function Pol_more_params(model::PhenomD_TIGER,
#     f::AbstractVector,
#     mc,
#     eta,
#     chi1,
...
Compute the phase of the GW as a function of frequency, given the events parameters.
    ...
    Phi(PhenomD_TIGER(), f, mc, eta, chi1, chi2)
...
```julia
    ...
    chi1 = 0.5
    chi2 = 0.5
    fcut = _fcut(PhenomD_TIGER(), mc, eta)
...
Compute the amplitude of the GW as a function of frequency, given the events parameters.
    ...
    Ampl(PhenomD_TIGER(), f, mc, eta, chi1, chi2, dL)
