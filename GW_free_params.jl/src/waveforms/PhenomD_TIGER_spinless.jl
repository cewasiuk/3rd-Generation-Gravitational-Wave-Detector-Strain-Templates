...
"""
function PolAbs(model::PhenomD_TIGER_spinless,
    f::AbstractVector,
    mc,
    eta,
    chi1,
...
ToDo: Need documentation
"""
function Pol(model::PhenomD_TIGER_spinless,
    f::AbstractVector,
    mc,
    eta,
    chi1,
...
# function Pol_more_params(model::PhenomD_TIGER_spinless,
#     f::AbstractVector,
#     mc,
#     eta,
#     chi1,
...
#     GMsun_over_c3 = uc.GMsun_over_c3,
#     GMsun_over_c2_Gpc = uc.GMsun_over_c2_Gpc,
#     extra_param_karg = nothing,
    
# )

#     hp, hc = PolAbs_more_params(
#         model,
#         f,
#         mc,
#         eta,
...
#         GMsun_over_c3 = GMsun_over_c3,
#         GMsun_over_c2_Gpc = GMsun_over_c2_Gpc,
#         extra_param_karg = extra_param_karg,
#     )
...
Compute the phase of the GW as a function of frequency, given the events parameters.
    ...
    Phi(PhenomD_TIGER_spinless(), f, mc, eta, chi1, chi2)
...
```julia
    ...
    chi1 = 0.5
    chi2 = 0.5
    fcut = _fcut(PhenomD_TIGER_spinless(), mc, eta)
...
function Phi(model::PhenomD_TIGER_spinless,
    ...
    DPhiIns =
        (
            ...
            7.0 * TF2coeffs.minus_two * TF2OverallAmpl * ((pi * fInsJoin)^(-2.0 / 3.0))
    ...
    PhiInsJoin =
        ...
        PhiInspcoeffs.min_seven_thirds * (fInsJoin^(-7. /3.)) +
        (
    ...
    phiRef = ifelse(
        ...
        PhiInspcoeffs.min_seven_thirds * (fRef^(-7. /3.)) +
        (
    ...
    phis = @. ifelse.(
        ...
        PhiInspcoeffs.min_seven_thirds * (fgrid^(-7. /3.)) +
        (
...
Compute the amplitude of the GW as a function of frequency, given the events parameters.
    ...
    Ampl(PhenomD_TIGER_spinless(), f, mc, eta, chi1, chi2, dL)
