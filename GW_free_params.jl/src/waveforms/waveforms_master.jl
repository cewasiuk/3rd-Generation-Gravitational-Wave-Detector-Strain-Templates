...
function _extrinsic_parameter_names(model::NonCBC)
    return (:dL, :theta, :phi, :iota, :psi, :tcoal, :phiCoal)
end

function _parameter_names(model::NonCBC)
    return (_intrinsic_parameter_names(model)..., _extrinsic_parameter_names(model)...)
end
